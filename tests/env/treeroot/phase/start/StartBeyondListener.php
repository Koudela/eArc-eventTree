...
class StartBeyondListener extends BaseListener implements PhaseSpecificListenerInterface
{
    public static function getPhase(): int
    {
        return ObserverTreeInterface::PHASE_START | ObserverTreeInterface::PHASE_BEYOND;
    }
}
